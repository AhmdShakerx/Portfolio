    ...
    <>
      <AnimatePresence>
        {showIntro && (
          ...
          >
            <ParticleTextEffect onComplete={() => setShowIntro(false)} />
          </motion.div>
        )}
      </AnimatePresence>
      <div className={`min-h-screen bg-darker text-light font-sans selection:bg-primary/30 transition-opacity duration-1000 ${showIntro ? "opacity-0 h-screen overflow-hidden" : "opacity-100"}`}>
        {/* Navigation */}
      <motion.nav 
      ...
      {/* Hero Section */}
      <section id="home" className="relative h-screen flex items-center justify-center pt-20 overflow-hidden w-full group cursor-none [&_a]:cursor-pointer [&_button]:cursor-pointer">
        <Particles />
        <MouseSpotlight />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full h-full flex flex-col justify-center pointer-events-none">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            className="w-full md:w-[60%] text-center md:text-left mt-10 md:mt-0"
          >
            <span className="text-primary font-mono tracking-widest text-sm uppercase mb-4 block">Hello, I'm</span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 drop-shadow-[0_0_15px_rgba(0,0,0,0.5)]">
              <span className="text-gradient">Ahmed Shaker</span>
            </h1>
            <p className="text-gray text-lg md:text-xl max-w-lg mx-auto md:mx-0 mb-10 leading-relaxed font-medium drop-shadow-md">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pointer-events-auto">
              <motion.a 
                href="#projects" 
              ...
              items={[
                {
                  id: 1,
                  title: "Azaban System",
                  description: "A comprehensive e-commerce platform and integrated management system.",
                  imageSrc: "/Screenshot 2026-05-20 233100.png",
                  href: "https://purple-bear-616763.hostingersite.com/"
                },
                {
                  id: 2,
                  title: "Tafahom Platform",
                  description: "An advanced EdTech solution featuring the 'Faheem' AI engine to generate professional exams.",
                  imageSrc: "/Screenshot 2026-04-19 231223.png",
                  href: "https://tafahomedu.com/"
                },
                {
                  id: 3,
                  title: "AZ-Learning",
                  description: "A contemporary user interface for an online learning platform. It utilizes a modern dark theme.",
                  imageSrc: "/az.png",
                  href: "https://az-learning-delta.vercel.app/"
                },
                {
                  id: 4,
                  title: "English Academy",
                  description: "A modern UI design for an Arabic e-learning platform.",
                  imageSrc: "/ayman.png",
                  href: "https://english-academy-eta.vercel.app/"
                },
                {
                  id: 5,
                  title: "Best Rate",
                  description: "A professional and straightforward corporate website design for a freight forwarding and logistics company.",
                  imageSrc: "/best.png",
                  href: "https://ahmdshakerx.github.io/Best-Rate/"
                },
                {
                  id: 6,
                  title: "ELEGANTER",
                  description: "A sophisticated landing page designed to showcase a premium HTML5 template.",
                  imageSrc: "/ava.png",
                  href: "https://ahmdshakerx.github.io/ELEGANTER/"
                },
                {
                  id: 7,
                  title: "Digital Studio",
                  description: "A sleek, dark-themed website design tailored for a digital agency or creative studio.",
                  imageSrc: "/digital-1.png",
                  href: "https://ahmdshakerx.github.io/Digital-Studio/"
                },
                {
                  id: 8,
                  title: "pink shield",
                  description: "Pink Shield is an AI-powered healthcare platform focused on early breast cancer detection.",
                  imageSrc: "/pink.png",
                  href: "https://pink-shield.vercel.app/"
                },
                {
                  id: 9,
                  title: "Delicious",
                  description: "A clean, bright, and modern website design for a restaurant.",
                  imageSrc: "/delechice.png",
                  href: "https://ahmdshakerx.github.io/Delicious/"
                },
                {
                  id: 10,
                  title: "HVAC",
                  description: "A trust-building website design for an HVAC and home services provider.",
                  imageSrc: "/pro.png",
                  href: "https://ahmdshakerx.github.io/HVAC/"
                }
              ]}
            />
          </div>
